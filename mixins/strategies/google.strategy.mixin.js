  ...
  methods: {
    registerGoogleStrategy(setting, route) {
      ...
      try {
        ...
        this.logger.error(
          `The 'passport-google-oauth20' package is missing.
          Please install it with 'npm i passport-google-oauth20' command.`
        )
        return
      }
          ...
          Object.assign(
            {
              ...
              // SERVICES_DOMAIN should end with /
              callbackURL: `${process.env.SERVICES_DOMAIN}auth/${providerName}/callback`
            },
            setting
          ),
